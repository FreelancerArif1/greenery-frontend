    ...
    return (
        <StyledComponent className={'contact-form pb-120 pt-160'}>
            <Container>
                <Form className={'form'} >
                    <Row className={'rows'}>
                        <Col lg={{span:6}} className='contact-left'>
                                    ...
                                    <Col className='pl-2' md={6}>
                                        <div className={'contact-left__email'}>
                                            ...
                                            <div className={'contact-info'}>
                                                    ...
                                                    <a href={'tel:+8801324251244'}>+8801324251244</a>
                                    ...
                                    {/* <Col md={6}>
                                        <div className={'contact-left__email'}>
                                            <div className={'contact-info'}>
                                                ...
                                                <div className="wrapper">
                                                    <a href={'tel:++88+8801324251244'}>+88+8801324251244</a><br/>
                                                    <a href={'tel:+8801521 747410'}>+8801521 747410</a>
                                                </div>
                                            </div>
                                        </div>
...
margin-bottom: 10px;
    ...
    .contact-right{
        ...
        .contact-info{
            padding: 10px 0;
            border-bottom: 0.5px solid rgba(159, 159, 159, 0.1);
            display: flex;
            gap: 20px;
